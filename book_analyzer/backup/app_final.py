# app_final.py
# Complete Book Analyzer with EPUB, PDF, Bulgarian, Export Reports
...
def generate_pdf_report(text, results, filename):
    ...
    stats_data = [
        ...
        ['Total Sentences', str(len(results['sentiment']))],
    ]
...
with st.sidebar.expander("📤 Export", expanded=False):
    ...
    export_format = st.selectbox("Format", ["PDF Report", "CSV Data", "JSON"])
